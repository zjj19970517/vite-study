...
export async function createOptimizeDepsRun(
  ...
  // root /Users/zhangjinjie/workspace/meils/vite/vite-ts
  // logger 日志对象
  const { root, logger } = config
  const log = asCommand ? logger.info : debug

  // cacheDir: /Users/zhangjinjie/workspace/meils/vite/vite-ts/node_modules/.vite
  // dataPath: /Users/zhangjinjie/workspace/meils/vite/vite-ts/node_modules/.vite/_metadata.json
  // 读取 _metadata.json
